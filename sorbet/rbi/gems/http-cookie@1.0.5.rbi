...
#
# source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#12
class HTTP::CookieJar::MozillaStore < ::HTTP::CookieJar::AbstractStore
  ...
  #
  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#92
  def initialize(options = T.unsafe(nil)); end

  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#424
  def add(cookie); end

  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#553
  def cleanup(session = T.unsafe(nil)); end

  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#522
  def clear; end

  # Closes the SQLite3 database.  After closing, any operation may
  # raise an error.
  #
  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#127
  def close; end
  ...
  # @return [Boolean]
  #
  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#133
  def closed?; end

  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#15
  def default_options; end

  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#434
  def delete(cookie); end

  # :yield: cookie
  #
  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#460
  def each(uri = T.unsafe(nil), &block); end

  # The file name of the SQLite3 database given in initialization.
  #
  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#123
  def filename; end

  # Returns the schema version of the database.
  #
  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#138
  def schema_version; end

  protected

  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#208
  def create_table; end

  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#152
  def create_table_v5; end

  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#181
  def create_table_v6; end

  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#352
  def db_add(cookie); end

  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#381
  def db_delete(cookie); end

  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#237
  def db_prepare(sql); end

  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#418
  def deserialize_usectime(value); end

  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#393
  def encode_www_form(enum); end

  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#397
  def get_query_param(str, key); end

  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#147
  def schema_version=(version); end

  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#414
  def serialize_usectime(time); end

  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#244
  ...
  # @raise [TypeError]
  #
  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#118
  def initialize_copy(other); end
end

# source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#23
HTTP::CookieJar::MozillaStore::ALL_COLUMNS = T.let(T.unsafe(nil), Array)

# source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#35
HTTP::CookieJar::MozillaStore::Callable = T.let(T.unsafe(nil), Proc)

# source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#41
class HTTP::CookieJar::MozillaStore::Database < ::SQLite3::Database
  # @return [Database] a new instance of Database
  #
  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#42
  def initialize(file, options = T.unsafe(nil)); end

  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#58
  def close; end

  # source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#50
  def prepare(sql); end
end

# :stopdoc:
#
# source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#13
HTTP::CookieJar::MozillaStore::SCHEMA_VERSION = T.let(T.unsafe(nil), Integer)

# source://http-cookie//lib/http/cookie_jar/mozilla_store.rb#33
HTTP::CookieJar::MozillaStore::SQL = T.let(T.unsafe(nil), Hash)
